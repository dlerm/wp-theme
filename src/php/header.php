...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php bloginfo('stylesheet_url'); ?>?<? echo time(); ?>" />
  ...
  <script src="https://code.jquery.com/jquery-3.4.1.slim.min.js" defer="defer"></script>
</head>
